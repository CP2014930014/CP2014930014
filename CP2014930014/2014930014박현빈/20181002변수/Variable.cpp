...
//======이 위는 당분간 무시
	...
	// 대입연산자
	a = b = c = 100;		// 얘도 수식. =도 연산자임.

	// 증감 연산자
	b=10;
	a = b++;	// b++ : 반환값=>b, 부수효과=>b=b+1	==> a=10, b=11 된다.
	b = 10;
	a = ++b;	// ++b : 반환값=>b+1, 부수효과=>b=b+1		==> a=11, b=11
	...
	a = 10 + 20 * 3;		// 곱하기 먼저
	a = 1 || 3 * 4 > 10;		// 단항연산자 -> 산술연산자 -> 관계연산자 -> 논리연산자 -> 조건연산자 -> 대입연산자
	// 그냥 보기 좋게 괄호쳐서 해라.
